...
#    Updated: 2024/03/10 00:26:42 by cbernot          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LST_CMD = Pass.cpp Commands.cpp Unknown.cpp Quit.cpp User.cpp Nick.cpp Motd.cpp Ping.cpp Join.cpp Part.cpp Mode.cpp Topic.cpp Kick.cpp
